  ...
  stages {
    ...
    stage('Deploy') {
      steps {
        ...
        bat(script: 'xcopy /S /Y /I "%JENKINS_HOME%\\workspace\\%JOB_NAME:/=_%\\DevopsTest\\bin\\Release\\Publish" "H:\\CodeWorkspace\\PrinceWorkSpace\\Deploy\\DevopsTest\\Test"', label: 'Deploy Files')
      }
    }
  }
}